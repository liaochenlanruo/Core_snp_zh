...
foreach my $file (@store_array) {
  ...
  system("perl /run/media/bmb1/liaochenlanruo/Analysis/SNP/core_snp/20160303/pal2nal.pl $inputproteindir/$file $inputdnadir/$name.fa -nogap -output fasta -codontable 11 > $outputdir/$name.codon.aln")
}
